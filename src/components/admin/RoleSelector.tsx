...
export default function RoleSelector({ selectedRole, onChange, disabled = false }: RoleSelectorProps) {
  const roles: RoleOption[] = [
    ...
    },
    {
      ...
      description: 'إدخال ومتابعة معاملات الشركة وإعداد التقارير الأولية وإسناد القضايا.',
    ...
    },
    {
      ...
      description: 'عرض ومتابعة القضايا والتحصيلات المكلف بها شخصياً فقط بمستويات وصول محدودة.',
      icon: <User className="w-5 h-5" />,
      colorClass: 'from-slate-500 to-slate-700',
    },
    {
      value: 'law_firm_manager',
      label: 'مدير مكتب المحاماة الشريك',
      description: 'إدارة القضايا الخاصة بمكتبه، وتعديل حالاتها وإسناد المهام والجلسات لمساعديه.',
      icon: <Scale className="w-5 h-5" />,
      colorClass: 'from-blue-500 to-indigo-600',
    },
    {
      value: 'law_firm_assistant',
      label: 'محامي مساعد بمكتب الشركاء',
      description: 'صلاحيات مساندة لمراجعة الجلسات وتحديث القضايا المسندة له بداخل مكتبه.',
